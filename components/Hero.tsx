...
export function Hero(){
 ...
 return <section id="início" className="relative overflow-hidden rounded-3xl border border-white/10 bg-[#07101d] p-8 md:p-12 bg-grid">
   ...
   <div className="relative grid gap-8 lg:grid-cols-2 lg:items-center">
    ...
    <div className="relative"><div className="mx-auto aspect-[4/3] max-w-xl rounded-3xl border border-brand-500/30 bg-gradient-to-br from-brand-600/30 to-purple-500/10 p-6 shadow-2xl"><div className="grid h-full place-items-center rounded-2xl bg-black/30 text-center"><div className="text-8xl">💻📱🎧</div><p className="mt-5 text-slate-300">Banner de produtos em destaque</p></div></div></div>
   </div>
