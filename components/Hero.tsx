...
export function Hero(){
 ...
 return <section id="início" className="relative overflow-hidden rounded-3xl border border-sky-200 bg-gradient-to-br from-sky-100 via-cyan-50 to-blue-100 p-8 text-slate-900 shadow-xl shadow-sky-900/10 md:p-12 bg-grid">
   ...
   <div className="relative grid gap-8 lg:grid-cols-2 lg:items-center">
    <div><span className="rounded-full bg-sky-700 px-3 py-1 text-xs font-bold text-white">VITALINO TECH</span><h1 className="mt-6 max-w-2xl text-4xl font-black leading-tight md:text-6xl">As melhores ofertas de tecnologia <span className="text-sky-700">você encontra aqui!</span></h1><p className="mt-5 max-w-xl text-lg text-slate-700">Compare preços, divulgue produtos de afiliados e apresente seus serviços de TI em uma plataforma moderna.</p><a href="#produtos-por-categoria" className="mt-7 inline-flex items-center gap-2 rounded-xl bg-sky-700 px-6 py-3 font-bold text-white shadow-lg shadow-sky-700/20 transition hover:bg-sky-600">Ver ofertas <ArrowRight size={18}/></a></div>
