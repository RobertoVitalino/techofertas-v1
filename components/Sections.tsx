...
const featuredNews = [
  {
    title: 'Suspender as lives do Discord protege os jovens ou apenas transfere o problema?',
    category: 'Games e Consoles',
    summary: 'Suspensão de lives do Discord no Brasil pela ANPD reacende debate sobre proteção de menores, criptografia, privacidade e limites da moderação.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/08/Discord-Folha.jpg',
    href: 'https://olhardigital.com.br/2026/08/20/games-e-consoles/discord-suspende-lives-no-brasil-e-levanta-debate-sobre-seguranca-de-menores-e-criptografia/',
  },
  {
    title: 'Stop Killing Games critica grupo responsável por vazamentos de GTA 6 e alerta fãs',
    category: 'Games e Consoles',
    summary: 'Stop Killing Games condenou os vazamentos de GTA 6 feitos pelo Cyberleek e pediu que fãs não enviem dinheiro ao grupo nem apoiem sua criptomoeda.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/08/GTA-6-Rolling-Stone-Brasil-1.jpg',
    href: 'https://olhardigital.com.br/2026/08/20/games-e-consoles/stop-killing-games-condena-vazamentos-de-gta-6/',
  },
  {
    title: 'Missão falhou: NASA desiste de resgatar observatório Swift e aguarda queda em 2026',
    category: 'Ciência e Espaço',
    summary: 'NASA cancelou missão de resgate do observatório Swift após falha na espaçonave LINK. Satélite estava em operação desde 2004',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/04/nasa-swift-telescpio-scaled.jpg',
    href: 'https://olhardigital.com.br/2026/08/20/ciencia-e-espaco/missao-falhou-nasa-desiste-de-resgatar-observatorio-swift-e-aguarda-queda-em-2026/',
  },
  {
    title: 'Previsão do tempo: Ciclone no Sul abre caminho para frente fria',
    category: 'Ciência e Espaço',
    summary: 'Ciclone pode levar temporais e ventanias para o Sul, o que abre passagem para massa de ar polar avançar até na região Norte',
    image: 'https://olhardigital.com.br/wp-content/uploads/2025/05/Destaque-pessoas-agasalhadas-frio-scaled.jpg',
    href: 'https://olhardigital.com.br/2026/08/20/ciencia-e-espaco/previsao-do-tempo-ciclone-no-sul-abre-caminho-para-frente-fria/',
  },
  {
    title: 'Guardinha robô organiza trânsito e alerta motoristas na China',
    category: 'Robótica',
    summary: 'Com quase dois metros de altura, o robô T2 da SUPCON Information usa câmeras e radar para apontar infrações em tempo real',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/08/Destaque-Robo-guardinha-de-transito-scaled.jpg',
    href: 'https://olhardigital.com.br/2026/08/20/robotica/guardinha-robo-organiza-transito-e-alerta-motoristas-na-china/',
  },
]
// AUTO-NEWS-END
