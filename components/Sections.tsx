...
const featuredNews = [
  {
    title: 'Há 2 mil anos, agricultores controlavam sistemas de água monumentais',
    category: 'Ciência e Espaço',
    summary: 'Comunidades pré-hispânicas da Colômbia criaram sistemas de água e campos para controlar secas e enchentes há séculos hoje.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/08/rede-de-canais-la-mojana.jpg',
    href: 'https://olhardigital.com.br/2026/08/12/ciencia-e-espaco/ha-2-mil-anos-agricultores-controlavam-sistemas-de-agua-monumentais/',
  },
  {
    title: 'Quando e onde será o próximo eclipse solar total?',
    category: 'Ciência e Espaço',
    summary: 'Nesta quarta-feira (12), o céu de alguns locais privilegiados do globo serão tomados por um eclipse solar total; saiba quando será o próximo',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/08/eclipse-solar-total-fases.jpg',
    href: 'https://olhardigital.com.br/2026/08/12/ciencia-e-espaco/quando-e-onde-sera-o-proximo-eclipse-solar-total/',
  },
  {
    title: 'Avião militar autônomo comandado por IA faz seus primeiros testes',
    category: 'Veículos e Tecnologia',
    summary: 'Sensores infravermelhos permitiram ao caça detectar um alvo real e reagir em tempo real, sem depender de radar ativo durante o teste',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/08/x-62a-aviao-militar-pilotado-por-ia.jpg',
    href: 'https://olhardigital.com.br/2026/08/12/carros-e-tecnologia/aviao-militar-autonomo-comandado-por-ia-faz-seus-primeiros-testes/',
  },
  {
    title: 'Alzheimer raro: estrutura da proteína ajuda a explicar hemorragias no cérebro',
    category: 'Medicina e Saúde',
    summary: 'Alzheimer raro revela uma dobra inédita da beta-amiloide em forma de Z, ligada ao acúmulo da proteína nos vasos cerebrais.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/08/alzheimer-1.jpg',
    href: 'https://olhardigital.com.br/2026/08/12/medicina-e-saude/alzheimer-raro-estrutura-da-proteina-ajuda-a-explicar-hemorragias-no-cerebro/',
  },
  {
    title: 'Este pode ser o próximo país a pisar na Lua',
    category: 'Pro',
    summary: 'Coreia do Sul lança plano para disputar tecnologias estratégicas e mira energia, computação quântica e novos mercados até 2035',
    image: 'https://olhardigital.com.br/wp-content/uploads/2024/09/coreia-do-sul-1.jpg',
    href: 'https://olhardigital.com.br/2026/08/12/pro/este-pode-ser-o-proximo-pais-a-pisar-na-lua/',
  },
]
// AUTO-NEWS-END
