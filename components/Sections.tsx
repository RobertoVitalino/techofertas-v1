...
const featuredNews = [
  {
    title: 'Pix apresenta instabilidade na manhã deste domingo (23)',
    category: 'Internet e Redes Sociais',
    summary: 'Plataforma de monitoramento indica pico de reclamações desde as primeiras horas da manhã; usuários relatam erro ao enviar valores.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/08/Destaque-Pix-11-de-agosto-de-2026-scaled.jpg',
    href: 'https://olhardigital.com.br/2026/08/23/internet-e-redes-sociais/pix-apresenta-instabilidade-na-manha-deste-domingo-23/',
  },
  {
    title: 'Jogos de hoje (23/08/26): onde assistir futebol ao vivo e horários das partidas',
    category: 'Internet e Redes Sociais',
    summary: 'Confira aqui, no Olhar Digital, onde assistir, ao vivo, às partidas de hoje, 23 de agosto de 2026. Veja os horários dos jogos de hoje',
    image: 'https://img.odcdn.com.br/wp-content/uploads/2024/06/futebol-streaming.jpg',
    href: 'https://olhardigital.com.br/2026/08/23/internet-e-redes-sociais/jogos-de-hoje-23-08-26-onde-assistir-futebol-ao-vivo-e-horarios-das-partidas/',
  },
  {
    title: 'Lua hoje: confira a fase da Lua deste domingo 23/08/2026',
    category: 'Ciência e Espaço',
    summary: 'Em qual fase a Lua está hoje, domingo, 23 de agosto de 2026? Confira e veja o calendário lunar completo deste mês',
    image: 'https://img.odcdn.com.br/wp-content/uploads/2026/06/lua-crescente-01.jpg',
    href: 'https://olhardigital.com.br/2026/08/23/ciencia-e-espaco/lua-hoje-confira-a-fase-da-lua-deste-domingo-23-08-2026/',
  },
  {
    title: 'IA já controla embarcações sem tripulação no mar e pode ser operada a 300 km de distância',
    category: 'Veículos e Tecnologia',
    summary: 'Startup brasileira opera embarcação autônoma para a Petrobras a 100 km da costa, controlada a 300 km via satélite',
    image: 'https://img.odcdn.com.br/wp-content/uploads/2026/08/Tidewise-6.jpeg',
    href: 'https://olhardigital.com.br/2026/08/23/carros-e-tecnologia/ia-ja-controla-embarcacoes-sem-tripulacao-no-mar-e-pode-ser-operada-a-300-km-de-distancia/',
  },
  {
    title: 'Coritiba x Corinthians: onde assistir, horário e escalação do jogo do Brasileirão',
    category: 'Internet e Redes Sociais',
    summary: 'Confira onde assistir, horário e prováveis escalações de Coritiba e Corinthians; duelo é válido pela 24ª rodada do Brasileirão',
    image: 'https://img.odcdn.com.br/wp-content/uploads/2026/08/Coritiba-x-Corinthians-scaled.jpg',
    href: 'https://olhardigital.com.br/2026/08/23/internet-e-redes-sociais/coritiba-x-corinthians-onde-assistir-horario-e-escalacao-do-jogo-do-brasileirao/',
  },
]
// AUTO-NEWS-END
