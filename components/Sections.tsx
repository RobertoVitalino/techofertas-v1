...
const featuredNews = [
  {
    title: 'Perder visão no espaço preocupa agências antes de viagens à Lua',
    category: 'Ciência e Espaço',
    summary: 'Um dispositivo em desenvolvimento pode ajudar astronautas a monitorar alterações nos olhos durante missões prolongadas no espaço.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/08/olho-aberto.jpg',
    href: 'https://olhardigital.com.br/2026/08/11/ciencia-e-espaco/perder-visao-no-espaco-preocupa-agencias-antes-de-viagens-a-lua/',
  },
  {
    title: 'Brasil está no coração de uma anomalia do campo magnético da Terra',
    category: 'Ciência e Espaço',
    summary: 'Especialista explica a Anomalia Magnética do Atlântico Sul, uma região onde o campo magnético da Terra é mais fraco – e que cobre o Brasil',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/08/anomalia-magntica-do-atlntico-sul-.jpg',
    href: 'https://olhardigital.com.br/2026/08/11/ciencia-e-espaco/brasil-esta-no-coracao-de-uma-anomalia-do-campo-magnetico-da-terra/',
  },
  {
    title: 'China aposta em IA para antecipar tempestades e ganhar tempo contra o clima extremo',
    category: 'Inteligência Artificial',
    summary: 'Modelos chineses de previsão ganham espaço diante de tecnologias tradicionais, mas ainda enfrentam limites para medir a força de tempestades',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/07/iStock-2233370282.jpg',
    href: 'https://olhardigital.com.br/2026/08/11/inteligencia-artificial/china-aposta-em-ia-para-antecipar-tempestades-e-ganhar-tempo-contra-o-clima-extremo/',
  },
  {
    title: 'Robô transforma violão comum em instrumento que toca sozinho',
    category: 'Robótica',
    summary: 'Robô criado na Nova Zelândia toca violão acústico a partir de tablaturas digitais e pode até dividir a performance com um músico.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/08/robo-violao.webp',
    href: 'https://olhardigital.com.br/2026/08/11/robotica/robo-transforma-violao-comum-em-instrumento-que-toca-sozinho/',
  },
  {
    title: 'Um avião supersônico mais silencioso? NASA testa o X-59',
    category: 'Veículos e Tecnologia',
    summary: 'NASA testa o X-59, avião supersônico criado para trocar o estrondo tradicional por um som mais suave sobre áreas habitadas.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/08/nasa-x-59.jpg',
    href: 'https://olhardigital.com.br/2026/08/11/carros-e-tecnologia/um-aviao-supersonico-mais-silencioso-nasa-testa-o-x-59/',
  },
]
// AUTO-NEWS-END
