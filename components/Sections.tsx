...
const featuredNews = [
  {
    title: 'O ritmo do aquecimento pode mudar o destino da circulação do Atlântico',
    category: 'Ciência e Espaço',
    summary: 'Estudo em Utrecht mostra que o oceano perde capacidade de adaptação quando o aquecimento ocorre em ritmo mais acelerado mundialmente',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/06/oceano-atlntico-scaled.jpg',
    href: 'https://olhardigital.com.br/2026/08/13/ciencia-e-espaco/o-ritmo-do-aquecimento-pode-mudar-o-destino-da-circulacao-do-atlantico/',
  },
  {
    title: '5 smartphones com baterias enormes que você pode comprar hoje mesmo no Brasil',
    category: 'Guia de Compras',
    summary: 'Listamos cinco modelos de celulares com baterias gigantes e que duram dias longe da tomada; conheça cada um deles',
    image: 'https://img.odcdn.com.br/wp-content/uploads/2026/08/bateria.jpg',
    href: 'https://olhardigital.com.br/2026/08/13/reviews/5-smartphones-com-baterias-enormes-que-voce-pode-comprar-hoje-mesmo-no-brasil/',
  },
  {
    title: 'Esta moto elétrica acelera como um carro e usa tomada comum',
    category: 'Veículos e Tecnologia',
    summary: 'A Avore EX2S chega a 114 km/h, tem bateria de 5 kWh e pode ser recarregada em uma tomada doméstica comum no uso diário urbano.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/08/moto-eletrica-avore.jpg',
    href: 'https://olhardigital.com.br/2026/08/13/carros-e-tecnologia/esta-moto-eletrica-acelera-como-um-carro-e-usa-tomada-comum/',
  },
  {
    title: 'Virgin Galactic adia nova nave e mira voos em 2027',
    category: 'Exploração Espacial',
    summary: 'Virgin Galactic adia para 2027 o primeiro voo comercial da nova nave, após encontrar centenas de ajustes durante a montagem.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/08/virgin-galactic.jpg',
    href: 'https://olhardigital.com.br/2026/08/13/ciencia-e-espaco/exploracao-espacial/virgin-galactic-adia-nova-nave-e-mira-voos-em-2027/',
  },
  {
    title: 'Pergunte ao YouTube: IA chega ao celular &#8211; mas não para todo mundo',
    category: 'Internet e Redes Sociais',
    summary: 'Usuários dos EUA agora podem pesquisar no YouTube com respostas contextuais e perguntas de acompanhamento dentro da mesma conversa',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/03/youtube.jpg',
    href: 'https://olhardigital.com.br/2026/08/13/internet-e-redes-sociais/youtube-expande-acesso-ao-ask-youtube-e-reforca-busca-com-inteligencia-artificial/',
  },
]
// AUTO-NEWS-END
