...
const featuredNews = [
  {
    title: 'Como a Anthropic vai marcar textos do Claude para cumprir lei da União Europeia',
    category: 'Inteligência Artificial',
    summary: 'Empresa detalhou como vai funcionar a marca d\'água invisível em textos escritos pelo Claude; entenda',
    image: 'https://img.odcdn.com.br/wp-content/uploads/2026/08/anthropic.jpg',
    href: 'https://olhardigital.com.br/2026/08/16/inteligencia-artificial/como-a-anthropic-vai-marcar-textos-do-claude-para-cumprir-lei-da-uniao-europeia/',
  },
  {
    title: 'Jogos de hoje (16/08/26): onde assistir futebol ao vivo e horários das partidas',
    category: 'Internet e Redes Sociais',
    summary: 'Confira aqui, no Olhar Digital, onde assistir, ao vivo, às partidas de hoje, 16 de agosto de 2026. Veja os horários dos jogos de hoje',
    image: 'https://img.odcdn.com.br/wp-content/uploads/2024/06/futebol-streaming.jpg',
    href: 'https://olhardigital.com.br/2026/08/16/internet-e-redes-sociais/jogos-de-hoje-16-08-26-onde-assistir-futebol-ao-vivo-e-horarios-das-partidas/',
  },
  {
    title: 'Lua hoje: confira a fase da Lua deste domingo 16/08/2026',
    category: 'Ciência e Espaço',
    summary: 'Em qual fase a Lua está hoje, domingo, 16 de agosto de 2026? Confira e veja o calendário lunar completo deste mês',
    image: 'https://img.odcdn.com.br/wp-content/uploads/2026/06/lua-minguante-3.jpg',
    href: 'https://olhardigital.com.br/2026/08/16/ciencia-e-espaco/lua-hoje-confira-a-fase-da-lua-deste-domingo-16-08-2026/',
  },
  {
    title: 'Os agentes de IA estão revolucionando o e-commerce',
    category: 'Colunistas',
    summary: 'A ascensão dos agentes de IA no e-commerce não deve ser lida como mais uma onda de automação incremental. É uma mudança de paradigma.',
    image: 'https://img.odcdn.com.br/wp-content/uploads/2025/12/e-commerce.jpg',
    href: 'https://olhardigital.com.br/2026/08/16/colunistas/os-agentes-de-ia-estao-revolucionando-o-e-commerce/',
  },
  {
    title: 'Atlético-MG x Grêmio: onde assistir, horário e escalações do jogo do Brasileirão',
    category: 'Internet e Redes Sociais',
    summary: 'Confira onde assistir, horário e escalações prováveis de Atlético-MG x Grêmio; partida é válida pela 23ª rodada do Brasileirão 2026',
    image: 'https://img.odcdn.com.br/wp-content/uploads/2025/08/atletico-mg-x-gremio-scaled.jpg',
    href: 'https://olhardigital.com.br/2026/08/16/internet-e-redes-sociais/atletico-mg-x-gremio-onde-assistir-horario-e-escalacoes-do-jogo-do-brasileirao/',
  },
]
// AUTO-NEWS-END
