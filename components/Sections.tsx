...
const featuredNews = [
  {
    title: 'State of Play: Final Fantasy VII, GTA 6 e Wolverine estão entre os destaques',
    category: 'Games e Consoles',
    summary: 'State of Play trouxe novidades de Final Fantasy VII Revelation, GTA 6, Wolverine, Metro 2039, Crimson Desert e outros jogos; confira os destaques.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/09/State-Of-Play-Setembro-Anuncios-ChatGPT.png',
    href: 'https://olhardigital.com.br/2026/09/03/games-e-consoles/state-of-play-setembro-de-2026-veja-todos-os-principais-anuncios/',
  },
  {
    title: 'Pix pode chegar à Europa e permitir pagamentos em euros',
    category: 'Pro',
    summary: 'Banco Central negocia integrar o Pix ao TIPS, sistema europeu de pagamentos instantâneos, com piloto previsto para 2028',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/09/pix.jpg',
    href: 'https://olhardigital.com.br/2026/09/03/pro/pix-pode-chegar-a-europa-e-permitir-pagamentos-em-euros/',
  },
  {
    title: 'Ciência errou? Origem da vida no oceano entra em xeque',
    category: 'Ciência e Espaço',
    summary: 'Estudo na PNAS indica que a vida na Terra pode ter surgido em lagos rasos, contestando a famosa teoria das fontes no fundo do mar.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/09/fonte-hidrotermal.jpg',
    href: 'https://olhardigital.com.br/2026/09/03/ciencia-e-espaco/ciencia-errou-origem-da-vida-no-oceano-entra-em-xeque/',
  },
  {
    title: 'DLSS 5 vaza antes do lançamento e transforma personagens de games em figuras estranhas',
    category: 'Games e Consoles',
    summary: 'Versão experimental do DLSS 5 vazou por NBA 2K27 e foi aplicada por modders em Control, Skyrim e Final Fantasy VII Rebirth.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/09/DLSS-5-Terra.webp',
    href: 'https://olhardigital.com.br/2026/09/03/games-e-consoles/dlss-5-vaza-e-modders-testam-ia-da-nvidia-em-control-e-final-fantasy-vii/',
  },
  {
    title: 'Apagão digital? Queda em massa afeta IAs, bancos, WhatsApp e serviços do governo',
    category: 'Internet e Redes Sociais',
    summary: 'Uma falha nos servidores em nuvem tirou as principais IAs do ar e gerou instabilidade em serviços digitais no Brasil.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/09/apagao.jpg',
    href: 'https://olhardigital.com.br/2026/09/03/internet-e-redes-sociais/apagao-digital-queda-em-massa-afeta-ias-bancos-whatsapp-e-servicos-do-governo/',
  },
]
// AUTO-NEWS-END
