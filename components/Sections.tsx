...
const featuredNews = [
  {
    title: 'Deadlock ganha modo competitivo, novo sistema de ranque e reformulação das partidas',
    category: 'Games e Consoles',
    summary: 'Deadlock recebe sua maior atualização até agora com modo competitivo, temporadas, novo sistema de ranque, matchmaking reformulado e mudanças na escolha de heróis.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/07/Deadlock-2-Steam.jpg',
    href: 'https://olhardigital.com.br/2026/07/31/games-e-consoles/deadlock-recebe-modo-competitivo/',
  },
  {
    title: 'OpenAI e Anthropic explicam falhas antes da nova Lei de IA',
    category: 'Inteligência Artificial',
    summary: 'Modelos de IA da OpenAI e Anthropic surpreendem em testes de segurança, enquanto Europa prepara novas regras para controlar riscos.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/04/europa-redes-sociais-scaled-e1783600864901.jpg',
    href: 'https://olhardigital.com.br/2026/07/31/inteligencia-artificial/openai-e-anthropic-explicam-falhas-antes-da-nova-lei-de-ia/',
  },
  {
    title: '70 anos da IA: como uma tecnologia dos anos 50 mudou tudo – duas vezes',
    category: 'Inteligência Artificial',
    summary: 'Do sonho de 1956 aos agentes de hoje, entenda como a IA dominou nossa rotina e os dilemas dessa nova era da humanidade',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/07/Destaque-70-anos-da-IA-scaled.jpg',
    href: 'https://olhardigital.com.br/2026/07/31/inteligencia-artificial/70-anos-da-ia-como-uma-tecnologia-dos-anos-50-mudou-tudo-duas-vezes/',
  },
  {
    title: 'Novo anel da Casio une relógio digital e monitoramento corporal',
    category: 'Produtos e Reviews',
    summary: 'Modelo chega primeiro à China e aposta em um formato incomum para se destacar entre dispositivos vestíveis com aparência mais discreta',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/07/relgio-de-dedo-casio-smart-ring-anel-inteligente.jpg',
    href: 'https://olhardigital.com.br/2026/07/31/reviews/novo-anel-da-casio-une-relogio-digital-e-monitoramento-corporal/',
  },
  {
    title: 'Estrelas gêmeas podem reescrever a história da nossa galáxia',
    category: 'Ciência e Espaço',
    summary: 'Estudar esses sistemas ajuda a compreender melhor a evolução estelar e a dinâmica de objetos que moldam a estrutura da nossa galáxia.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2025/10/Destaque-Exoplanetas-em-sistema-binario-scaled.jpg',
    href: 'https://olhardigital.com.br/2026/07/31/ciencia-e-espaco/estrelas-gemeas-podem-reescrever-a-historia-da-nossa-galaxia/',
  },
]
// AUTO-NEWS-END
