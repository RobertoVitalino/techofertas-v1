...
const featuredNews = [
  {
    title: 'Assassin’s Creed Black Flag Resynced recebe atualização com novo animal para resgatar',
    category: 'Games e Consoles',
    summary: 'Assassin’s Creed Black Flag Resynced recebeu o patch 1.0.7 com novo animal para resgatar, opções de personalização e diversas correções.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/09/asscbf.jpg.jpg',
    href: 'https://olhardigital.com.br/2026/09/02/games-e-consoles/assassins-creed-black-flag-resynced-recebe-atualizacao-1-0-7/',
  },
  {
    title: 'Sol pode “perder a memória” e dificultar previsões climáticas espaciais',
    category: 'Astronomia',
    summary: 'Se o Sol perde a “memória” ao fim de cada ciclo ímpar, e estamos no 25, como prever a atividade do ciclo 26 após o possível “reset”?',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/09/sol.jpg',
    href: 'https://olhardigital.com.br/2026/09/02/ciencia-e-espaco/sol-pode-perder-a-memoria-e-dificultar-previsoes-climaticas-espaciais/',
  },
  {
    title: 'Apagou a mensagem? Veja como a PF consegue recuperar dados de um celular',
    category: 'Segurança e Privacidade',
    summary: 'Entenda como a PF acessa dados de celulares sem a senha e encontra mensagens, imagens e outros rastros digitais',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/09/celular-2.jpg',
    href: 'https://olhardigital.com.br/2026/09/02/seguranca/apagou-a-mensagem-veja-como-a-pf-consegue-recuperar-dados-de-um-celular/',
  },
  {
    title: 'Crimson Desert ganha demo grátis que roda direto no navegador',
    category: 'Games e Consoles',
    summary: 'Crimson Desert recebeu uma demo gratuita de 20 minutos que roda diretamente pelo navegador, sem necessidade de download ou instalação.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/09/Crimson-Desert-PlayStation.jpg',
    href: 'https://olhardigital.com.br/2026/09/02/games-e-consoles/crimson-desert-ganha-demo-gratis-para-jogar-sem-baixar/',
  },
  {
    title: 'Onde está o Roman? NASA permite acompanhar sua viagem',
    category: 'Astronomia',
    summary: 'Telescópio Roman segue rumo a L2 com câmera de 300 MP para mapear bilhões de galáxias e estudar os mistérios do Universo.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/09/telescpio-roman.jpg',
    href: 'https://olhardigital.com.br/2026/09/02/ciencia-e-espaco/onde-esta-o-roman-nasa-permite-acompanhar-sua-viagem/',
  },
]
// AUTO-NEWS-END
