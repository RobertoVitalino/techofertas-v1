...
const featuredNews = [
  {
    title: 'Nova função do WhatsApp quer confirmar idade sem expor usuários',
    category: 'Internet e Redes Sociais',
    summary: 'WhatsApp testa confirmação de idade na Índia após novas regras de dados e busca garantir mais segurança e privacidade para usuários.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/08/whatsapp-cadeado.jpg',
    href: 'https://olhardigital.com.br/2026/08/06/internet-e-redes-sociais/nova-funcao-do-whatsapp-quer-confirmar-idade-sem-expor-usuarios/',
  },
  {
    title: 'GTA 6 terá vídeo inédito exibido primeiro na Netflix; Rockstar confirma parceria exclusiva',
    category: 'Games e Consoles',
    summary: 'Rockstar Games exibirá um vídeo inédito de GTA 6 primeiro na Netflix em 27 de agosto. O conteúdo chega ao YouTube horas depois.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/08/GTA-6-Capa-Rockstar-1-926x1024.jpg',
    href: 'https://olhardigital.com.br/2026/08/06/games-e-consoles/gta-6-ganhara-video-inedito-na-netflix/',
  },
  {
    title: 'Fabricante de robôs Unitree chega à bolsa chinesa com avaliação de US$ 9 bilhões',
    category: 'Pro',
    summary: 'Companhia pretende ampliar investimentos em hardware e software enquanto enfrenta riscos de restrições comerciais no mercado estadunidense',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/02/Imagem-85.jpg',
    href: 'https://olhardigital.com.br/2026/08/06/pro/fabricante-de-robos-unitree-chega-a-bolsa-chinesa-com-avaliacao-de-us-9-bilhoes/',
  },
  {
    title: 'GTA 6 ganha vídeo especial na Netflix; veja quando estreia',
    category: 'Games e Consoles',
    summary: 'Rockstar confirma gameplay estendido de GTA 6 na Netflix com apresentação inédita marcada para agosto e novidades sobre o aguardado jogo.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/08/GTA-6-Chatgpt-2.png',
    href: 'https://olhardigital.com.br/2026/08/06/games-e-consoles/gta-6-ganha-video-especial-na-netflix-veja-quando-estreia/',
  },
  {
    title: 'OpenAI reage à Apple na Justiça e tenta barrar ação judicial por segredos comerciais',
    category: 'Pro',
    summary: 'Disputa entre as gigantes de tecnologia ocorre em meio à corrida por novos dispositivos de IA e mudanças no mercado de consumo',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/07/apple_openai.jpg',
    href: 'https://olhardigital.com.br/2026/08/06/pro/openai-reage-a-apple-na-justica-e-tenta-barrar-acao-judicial-por-segredos-comerciais/',
  },
]
// AUTO-NEWS-END
