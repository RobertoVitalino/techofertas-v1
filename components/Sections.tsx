...
const featuredNews = [
  {
    title: 'Como o Discord conseguiu irritar toda a comunidade gamer em 2026',
    category: 'Games e Consoles',
    summary: 'Banimentos por engano, verificação de idade, vazamento de dados e investigação no Brasil colocaram a relação entre Discord e comunidade gamer à prova em 2026.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/09/Divulgao-Discord-1.jpg',
    href: 'https://olhardigital.com.br/2026/09/08/games-e-consoles/discord-por-que-a-comunidade-gamer-esta-irritada-em-2026/',
  },
  {
    title: 'Apple Watch SE 3: vale a pena comprar o smartwatch mais barato da Apple?',
    category: 'Guia de Compras',
    summary: 'Ele não é tão avançado quanto os modelos mais caros, mas ainda faz muita coisa interessante. Saiba mais sobre o Apple Watch SE 3',
    image: 'https://img.odcdn.com.br/wp-content/uploads/2026/09/apple1.jpg',
    href: 'https://olhardigital.com.br/2026/09/08/reviews/apple-watch-se-3-vale-a-pena-comprar-o-smartwatch-mais-barato-da-apple/',
  },
  {
    title: 'Xbox recebe sete jogos hoje, incluindo Call of Duty no Game Pass',
    category: 'Games e Consoles',
    summary: 'Xbox recebe sete jogos em 8 de setembro, incluindo Mewgenics, Halloween e Bus Simulator 27, enquanto Black Ops Cold War chega ao Game Pass.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/09/Call-of-Duty-Black-Ops-Cold-War-XBOX.jpg',
    href: 'https://olhardigital.com.br/2026/09/08/games-e-consoles/xbox-recebe-7-jogos-hoje-e-call-of-duty-chega-ao-game-pass/',
  },
  {
    title: 'Dinheiro esquecido em bancos: R$ 5,6 bilhões ainda podem ser resgatados. Saiba como',
    category: 'Pro',
    summary: 'Banco Central informa que R$ 5,64 bilhões continuam esquecidos em instituições financeiras e podem ser resgatados por pessoas e empresas.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/09/iStock-148018191.jpg',
    href: 'https://olhardigital.com.br/2026/09/08/pro/dinheiro-esquecido-em-bancos-r-56-bilhoes-ainda-podem-ser-resgatados-saiba-como/',
  },
  {
    title: 'Produção de carros no Brasil bate recorde e é a maior em 7 anos',
    category: 'Veículos e Tecnologia',
    summary: 'A produção de carros atinge o ápice desde 2019 no Brasil, com dois terços do crescimento sustentado por kits de peças importadas.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/09/veiculos-brasil.jpg',
    href: 'https://olhardigital.com.br/2026/09/08/carros-e-tecnologia/producao-de-carros-no-brasil-bate-recorde-e-e-a-maior-em-7-anos/',
  },
]
// AUTO-NEWS-END
