...
const featuredNews = [
  {
    title: 'Golpes com IA usam voz e rosto de vítimas como uma máscara, mostra estudo',
    category: 'Segurança e Privacidade',
    summary: 'Levantamento aponta golpes que usam IA para reproduzir voz e aparência de pessoas, além de fraudes com SIM swap no Brasil.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/08/iStock-2227797795.jpg',
    href: 'https://olhardigital.com.br/2026/08/26/seguranca/golpes-com-ia-usam-voz-e-rosto-de-vitimas-como-uma-mascara-mostra-estudo/',
  },
  {
    title: 'SpaceX recupera Starship no oceano em operação inédita e inicia viagem de volta aos EUA',
    category: 'Ciência e Espaço',
    summary: 'A Starship foi colocada com sucesso no navio holandês Forte, em uma operação de recuperação de veículos espaciais sem precedentes',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/08/image-42.png',
    href: 'https://olhardigital.com.br/2026/08/26/ciencia-e-espaco/spacex-recupera-starship-no-oceano-em-operacao-inedita-e-inicia-viagem-de-volta-aos-eua/',
  },
  {
    title: 'Desastre no Nepal deixa mortos e desaparecidos após inundação',
    category: 'Clima',
    summary: 'Inundação na fronteira do Nepal com o Tibete deixa mortos e 384 viajantes desaparecidos, além de causar destruição e deslizamentos.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/08/enchente-nepal.jpg',
    href: 'https://olhardigital.com.br/2026/08/26/ciencia-e-espaco/desastre-no-nepal-deixa-mortos-e-desaparecidos-apos-inundacao/',
  },
  {
    title: 'Olimpíadas de robôs na China mostram que não existe competição com os EUA',
    category: 'Robótica',
    summary: 'A edição de 2026 das “Olimpíadas dos Robôs” na China acaba nesta quarta-feira (26). E recordes foram quebrados',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/08/Destaque-Olimpiadas-de-robos-na-China-scaled.jpg',
    href: 'https://olhardigital.com.br/2026/08/26/robotica/olimpiadas-de-robos-na-china-mostram-que-nao-existe-competicao-com-os-eua/',
  },
  {
    title: 'Testamos! Confira o review completo do Galaxy Watch 9',
    category: 'Guia de Compras',
    summary: 'Novo smartwatch da Samsung mantém o design conhecido da linha e vem com novo processador e integração com IA',
    image: 'https://img.odcdn.com.br/wp-content/uploads/2026/08/watch9-2.jpg',
    href: 'https://olhardigital.com.br/2026/08/26/reviews/testamos-confira-o-review-completo-do-galaxy-watch-9/',
  },
]
// AUTO-NEWS-END
