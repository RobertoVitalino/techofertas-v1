...
const featuredNews = [
  {
    title: 'Tornado atinge cidade do Paraná e causa destruição; veja imagens',
    category: 'Ciência e Espaço',
    summary: 'Até o momento, foram identificadas 20 residências afetadas pelo tornado e 20 pessoas ficaram desalojadas e foram acolhidas por parentes.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/08/tornado-1.jpg',
    href: 'https://olhardigital.com.br/2026/08/09/ciencia-e-espaco/tornado-atinge-cidade-do-parana-e-causa-destruicao-veja-imagens/',
  },
  {
    title: 'Jogos de hoje (09/08/26): onde assistir futebol ao vivo e horários das partidas',
    category: 'Internet e Redes Sociais',
    summary: 'Confira aqui, no Olhar Digital, onde assistir, ao vivo, às partidas de hoje, 9 de agosto de 2026. Veja os horários dos jogos de hoje',
    image: 'https://olhardigital.com.br/wp-content/uploads/2024/06/futebol-streaming.jpg',
    href: 'https://olhardigital.com.br/2026/08/09/internet-e-redes-sociais/jogos-de-hoje-09-08-26-onde-assistir-futebol-ao-vivo-e-horarios-das-partidas/',
  },
  {
    title: 'Lua hoje: confira a fase da Lua deste domingo 09/08/2026',
    category: 'Ciência e Espaço',
    summary: 'Em qual fase a Lua está hoje, domingo, 9 de agosto de 2026? Confira e veja o calendário lunar completo deste mês',
    image: 'https://img.odcdn.com.br/wp-content/uploads/2025/11/fases-da-lua2-scaled.jpg',
    href: 'https://olhardigital.com.br/2026/08/09/ciencia-e-espaco/lua-hoje-confira-a-fase-da-lua-deste-domingo-09-08-2026/',
  },
  {
    title: 'One-person startups: a IA está criando empresas onde uma pessoa faz o trabalho de uma equipe inteira',
    category: 'Colunistas',
    summary: 'A maior transformação silenciosa da IA: ela não eliminou a necessidade de empreender. Eliminou infraestruturas necessárias para começar.',
    image: 'https://img.odcdn.com.br/wp-content/uploads/2026/07/startup-unicornio-ilustracao.jpg',
    href: 'https://olhardigital.com.br/2026/08/09/colunistas/one-person-startups-a-ia-esta-criando-empresas-onde-uma-pessoa-faz-o-trabalho-de-uma-equipe-inteira/',
  },
  {
    title: 'Flamengo x Vitória: onde assistir, horário e escalação do jogo do Brasileirão',
    category: 'Internet e Redes Sociais',
    summary: 'Confira onde assistir, horário e prováveis escalações de Flamengo e Vitória; duelo é válido pela 22ª rodada do Brasileirão',
    image: 'https://img.odcdn.com.br/wp-content/uploads/2026/04/Cruzeiro-x-Red-Bull-Bragantino.png',
    href: 'https://olhardigital.com.br/2026/08/09/internet-e-redes-sociais/flamengo-x-vitoria-onde-assistir-horario-e-escalacao-do-jogo-do-brasileirao/',
  },
]
// AUTO-NEWS-END
