...
const featuredNews = [
  {
    title: 'iPhone Duo, Samsung Galaxy Z Fold 8 e Xiaomi 18 Fold: as diferenças entre os dobráveis &#8220;passaporte&#8221;',
    category: 'Guia de Compras',
    summary: 'Três celulares flexíveis com o mesmo formato: confira a diferença entre o iPhone Duo, o Galaxy Z Fold 8 e o Xiaomi 18 Fold',
    image: 'https://img.odcdn.com.br/wp-content/uploads/2026/09/dobraveis.jpg',
    href: 'https://olhardigital.com.br/2026/09/10/reviews/iphone-duo-samsung-galaxy-z-fold-8-e-xiaomi-18-fold-as-diferencas-entre-os-dobraveis-passaporte/',
  },
  {
    title: 'Clube Olhar Digital dá 15% de desconto em cursos da Impacta, nota máxima no MEC',
    category: 'Pro',
    summary: 'O desconto é automático para assinantes do Clube e vale para mais de 100 cursos da Impacta, presenciais ou online.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2025/05/clube-od.png',
    href: 'https://olhardigital.com.br/2026/09/10/pro/clube-olhar-digital-da-15-de-desconto-em-cursos-da-impacta-nota-maxima-no-mec/',
  },
  {
    title: 'Nova IA da NASA usa 2 milhões de imagens para achar água na Lua',
    category: 'Ciência e Espaço',
    summary: 'IBM e NASA lançam modelo de IA de código aberto treinado com 2 milhões de imagens para localizar gelo e mapear crateras no solo lunar.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/09/shutterstock_2745992041.jpg',
    href: 'https://olhardigital.com.br/2026/09/10/ciencia-e-espaco/nova-ia-da-nasa-usa-2-milhoes-de-imagens-para-achar-agua-na-lua/',
  },
  {
    title: 'Samsung provoca Apple nas redes após lançamento do iPhone Duo',
    category: 'Produtos e Reviews',
    summary: 'Samsung reage ao iPhone Duo com outdoors e provocações nas redes, enquanto Apple entra no mercado de celulares dobráveis.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/09/samsung-x-apple.jpg',
    href: 'https://olhardigital.com.br/2026/09/10/reviews/samsung-provoca-apple-nas-redes-apos-lancamento-do-iphone-duo/',
  },
  {
    title: 'Show de luzes: observatório flagra fenômeno raro e meteoro riscando o céu no Sul do Brasil ',
    category: 'Astronomia',
    summary: '"Duendes vermelhos" surgem no céu do Sul do Brasil e são flagrados ao lado de um meteoro em registro raro – veja o vídeo!',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/09/meteoro-e-sprites-santa-maria.jpg',
    href: 'https://olhardigital.com.br/2026/09/10/ciencia-e-espaco/show-de-luzes-observatorio-flagra-fenomeno-raro-e-meteoro-riscando-o-ceu-no-sul-do-brasil/',
  },
]
// AUTO-NEWS-END
