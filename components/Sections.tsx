...
const featuredNews = [
  {
    title: 'Fatal Fury: City of the Wolves review: vale a pena o retorno da SNK?',
    category: 'Games e Consoles',
    summary: 'Fatal Fury: City of the Wolves traz a SNK de volta com visual de HQ, netcode ótimo e roster inusitado. Veja se vale a pena.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/09/Fatal-Fury-1-1.jpg',
    href: 'https://olhardigital.com.br/2026/09/25/games-e-consoles/fatal-fury-city-of-the-wolves-review-a-volta-triunfal-da-lenda-dos-fliperamas/',
  },
  {
    title: 'Cientistas descobrem ataque inédito de tubarão-branco a golfinho raro em praia do Brasil',
    category: 'Ciência e Espaço',
    summary: 'Um golfinho raro encontrado morto no Brasil tinha marcas de um tubarão-branco que o atacou ainda vivo no litoral brasileiro.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/09/toninha.jpg',
    href: 'https://olhardigital.com.br/2026/09/25/ciencia-e-espaco/cientistas-descobrem-ataque-inedito-de-tubarao-branco-a-golfinho-raro-em-praia-do-brasil/',
  },
  {
    title: 'Uma galáxia minúscula estava escondida no quintal da Via Láctea – e o Vera Rubin acaba de encontrá-la',
    category: 'Astronomia',
    summary: 'O Observatório Vera Rubin descobriu a Aquarius IV, uma galáxia anã ultrafraquíssima dominada por matéria escura na órbita da Via Láctea',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/09/vera-rubin-galaxia.png',
    href: 'https://olhardigital.com.br/2026/09/25/ciencia-e-espaco/uma-galaxia-minuscula-estava-escondida-no-quintal-da-via-lactea-e-o-vera-rubin-acaba-de-encontra-la/',
  },
  {
    title: 'Pesquisa revela por que consumidor quer trocar de celular, mas escolhe o próximo pelo preço',
    category: 'Produtos e Reviews',
    summary: 'Levantamento revela os motivos para trocar de celular, o peso do preço e quanto consumidores planejam gastar no próximo ano.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/09/sefl.jpg',
    href: 'https://olhardigital.com.br/2026/09/25/reviews/pesquisa-revela-por-que-consumidor-quer-trocar-de-celular-mas-escolhe-o-proximo-pelo-preco/',
  },
  {
    title: 'IA, improviso e games: como a Árvore criou um jogo em que cada partida é diferente',
    category: 'Games e Consoles',
    summary: 'Ricardo Justus explica como a Árvore usa IA generativa em Fábula Rasa, jogo brasileiro premiado no SXSW 2026, e analisa o impacto da tecnologia nos games.',
    image: 'https://olhardigital.com.br/wp-content/uploads/2026/09/Fabula-Rasa_Key-Art_Landscape-1.png',
    href: 'https://olhardigital.com.br/2026/09/25/games-e-consoles/arvore-usa-ia-para-criar-jogo-em-que-cada-partida-e-diferente/',
  },
]
// AUTO-NEWS-END
